    ...
    >
      ...
      {hasChild && (
        <div
          className={cx(
            levelOne
              ? 'p-3 border rounded-md transform absolute transition duration-500 ease-in-out origin-top hover:shadow-sm hover:shadow-gray-200 bg-white'
              : 'p-3 border rounded-md absolute top-0 right-0 transition duration-500 ease-in-out origin-top-left left-4 hover:shadow-sm hover:shadow-gray-200 bg-white  opacity-0',
            'child',
            'min-w-192',
          )}
        >
